...
const body = {
  ...
  messages: [
    ...
    {
      role: 'user',
      content: 'Reply with {"ok":true,"provider":"glm","purpose":"delegated-mindgames-readiness"}.'
    }
  ],
  temperature: 0.1,
  max_tokens: 160,
...
const res = await fetch(`${baseUrl}/chat/completions`, {
  ...
  headers: {
    ...
    ...(useOpenRouter ? { 'http-referer': 'https://delegated-mindgames.local', 'x-title': 'Delegated MindGames Arena' } : {})
  },
